...
_Абсолютная сходимость._ Ряд $sum a_n$ называется абсолютно сходящимся, если сходится ряд $sum |a_n|$.

_Теорема Коши._ Если ряд $sum a_n$ сходится абсолютно, то он сходится. 
