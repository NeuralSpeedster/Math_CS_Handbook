...
_Определение._ Топологическая сортировка ориентированного ацикличного графа (DAG) — это линейный порядок его вершин, такой что для каждого ребра $(u, v)$ вершина $u$ предшествует вершине $v$ в этом порядке.
Для графов  с циклом топологическая сортировка невозможна.
