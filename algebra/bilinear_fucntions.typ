...
_Определение._ Коническим сечением на плоскости $RR^2$ называется множество точек, заданное уравнением вида
$
  q(x) + 2 l(x) + c = 0,
$
где $q$ --- квадратичная форма на $RR^2$, $l$ --- линейная форма на $RR^2$, $c in RR$.
