...
#theorem([_Предложение._ Однородная система линейных уравнений, в которой количество уравнений меньше количества неизвестных, всегда имеет ненулевое решение.])
