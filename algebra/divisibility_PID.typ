...
*Определение.* Целостное кольцо $A$ называется факториальным, если $forall a in A: a != 0$ и $a in.not A^times$ его можно единственным способом разложить в произведение простых множителей с точносью до перестановки множителей и их замены на ассоциированные элементы.
...
*Определение.* Целостное кольцо $A$ называется кольцом главных идеалов, если любой его идеал является главным, то есть имеет вид $a A = {a dot x | x in A}$ для некоторого элемента $a in A$.



*Определение.* Идеал $I subset A$ называется простым, если из $a dot b in I$ следует, что $a in I$ или $b in I$.

*Определение.* Идеал $I subset A$ называется максимальным, если $I != A$ и нет идеала $J$, такого что $I subset J subset A$ по строгому включению.
...
+ $I subset D$ и $J subset D$.
+ Если $I subset D'$ и $J subset D'$, то $D subset D'$.
Обозначим его $(I, J)$

*Определение.* Наименьшим общим кратным идеалов $I$ и $J$ в кольце главных идеалов $A$ называется такой идеал $M$, что
+ $M subset I$ и $M subset J$.
+ Если $M' subset I$ и $M' subset J$, то $M' subset M$.
Обозначим его $[I, J]$.
