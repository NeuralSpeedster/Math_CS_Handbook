...
#emoji.book.red _Теорема._ Пусть даны объекты ${a_1, ..., a_N}$ и свойства ${alpha_1, ..., alpha_n}$. Обозначим $N(alpha_i)$ количество объектов, обладающих свойством $alpha_i$. За $N(alpha_i, alpha_j)$ --- количество объектов, обладающих свойствами $alpha_i, alpha_j$ и так далее. За $alpha'_i$ обзначим отрицание свойства $alpha_i$. Утверждается, что 
$
