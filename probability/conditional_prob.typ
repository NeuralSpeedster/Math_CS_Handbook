...
#theorem[
#emoji.book.red Интегральная формула Муавра-Лапласа. Пусть в схеме испытаний Бернулли число испытаний $n->oo$. Определим $x in RR$ и $p$ так, что $k = n p + x sqrt(n p q)$. Тогда верно
$
  pp_n (k) ~ frac(1, sqrt(2 pi n p q)) e^(-x^2 / 2).
$
]
